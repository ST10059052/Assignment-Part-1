...
while (option == 2)
    {
        ...
        inputOption = JOptionPane.showInputDialog("Show report - this feature is still in development. Coming Soon (Choose Option 3 to continue)");
        option = Integer.parseInt(inputOption);
    }
  //This option is still in development//
    while (option == 3)
    {
        ...
        inputOption = JOptionPane.showInputDialog("Quit(Choose Option 2 to quit)");
        option = Integer.parseInt(inputOption);
