...
public class Part2AssignmentProgramming {
   ...
   inputOption = JOptionPane.showInputDialog("Choose Option 1 - 3 if not program will fail");
        ...
        //After the user choose this option  display the add task option for the user to enter//
    {
        ...
        for(int i =0; i<2;i++) {
             String showInputDialog = JOptionPane.showInputDialog("How many task do you want? ");
...
// This piece of code from Object to JOptionPane will display the information the user has typed into an table//
